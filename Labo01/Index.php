<?php 
include("Serveur/Utilitaires/connexion.inc.php");
include("Serveur/Donnees/sqlFunctions.inc.php");
?>
...
<body>
    ...
    <!-- End Icon Image -->
    <!--NavBar-->
    <?php echo file_get_contents("Serveur/Utilitaires/navBar.html"); ?>
    
    <!-- End NavBar -->
    <!-- Background image -->
  <div class="bg-image">
    <!-- Modal Inscription-->
    <?php echo file_get_contents("Serveur/Utilitaires/inscription.html"); ?>

    <!-- End Modal Inscription -->
    <!-- Modal Connexion -->
    <?php echo file_get_contents("Serveur/Utilitaires/connexion.html"); ?>
    <!-- End Modal Connexion -->   
